...
generate() {
    ...
    (
        ...
        rdiff delta delta-base.signature ../v6.6.11_logstream.tar ../${base}-v6.6.11_logstream.delta
        xz -T 0 -9 -e -f ../${base}-v6.6.11_logstream.delta
...
versions=(v4.0.0 v4.0.0_logstream v4.1.1 v4.1.1_logstream v6.1.2 v6.1.2_logstream v6.2.1 v6.2.5 v6.2.5_logstream)
